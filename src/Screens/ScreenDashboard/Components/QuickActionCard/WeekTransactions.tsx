...
import { getTransactionsByWeek, getCategories } from '../../../../db/database'; 
import styles from './StylesQuickAction';

interface WeekTransactionProps {
  onClose: () => void;
}
...
const WeekTransactions: React.FC<WeekTransactionProps> = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    const fetchTransactions = async () => {
      try {
        const fetchedTransactions = await getTransactionsByWeek();
